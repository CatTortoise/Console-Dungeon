...
namespace Console_Dungeon
{
    class Map
    {
        ...
        {
            _mapEntities = new Entity[] { new("P1",true, new Location(5,5), new Location(5, 5), Elements.Player,0), new("g1", false, new Location(7, 5), new Location(7, 5), Elements.Goblin, 1) };
